 ...
 */
if let penncapital = states["Pennsylvania"] {
...
let state = "New York"
states[state]
if let statesCapital = states[state] {
    print("The capital of \(state) is \(statesCapital)")
}
...
let bandName = "Pixies"
band[bandName]
if let bandMembers = band[bandName] {
        print("The band members of the \(bandName) are \(bandMembers.joined(separator: ", "))")
}
